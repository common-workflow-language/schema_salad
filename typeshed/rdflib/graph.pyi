...
class Graph(Node):
    ...
    formula_aware: bool = ...
    default_union: bool = ...
    def __init__(self, store: str = ..., identifier: Optional[Any] = ..., namespace_manager: Optional[Any] = ..., base: Optional[Any] = ...) -> None: ...
    store: Any = ...
    identifier: Any = ...
    ...
    def bind(self, prefix: Any, namespace: Any, override: bool = ..., replace: bool = ...): ...
    ...
    def parse(self, source: Optional[Any] = ..., publicID: Optional[Any] = ..., format: Optional[str] = ..., location: Optional[Any] = ..., file: Optional[Any] = ..., data: Optional[Any] = ..., **args: Any): ...
    ...
    def skolemize(self, new_graph: Optional[Any] = ..., bnode: Optional[Any] = ..., authority: Optional[Any] = ..., basepath: Optional[Any] = ...): ...
...
class ConjunctiveGraph(Graph):
    ...
    default_union: bool = ...
    default_context: Any = ...
    def __init__(self, store: str = ..., identifier: Optional[Any] = ..., default_graph_base: Optional[Any] = ...) -> None: ...
    ...
    def get_context(self, identifier: Any, quoted: bool = ..., base: Optional[Any] = ...): ...
...
class Dataset(ConjunctiveGraph):
    ...
    default_context: Any = ...
    default_union: Any = ...
    def __init__(self, store: str = ..., default_union: bool = ..., default_graph_base: Optional[Any] = ...) -> None: ...

...
from typing import AnyStr, Dict, List, NamedTuple, Optional, Tuple, Sequence, Union, overload
...
def urlparse(url: Optional[_String], scheme: _String = ...,
             allow_fragments: bool = ...) -> ParseResult: ...
def urlsplit(url: Optional[_String], scheme: _String = ...,
             allow_fragments: Optional[bool] = ...) -> SplitResult: ...
@overload
...
def urljoin(base: Optional[_String], url: _String,

        ...
        match type_declaration:
            ...
            case str(decl):
                if decl in self.extended_by:
                    ...
                    return self.declare_type(
                        TypeDef(
                            name=f"{name}ProxyLoader",
                            init='_ProxyLoader("{}")'.format(name + "Loader"),
                            instance_type=self.inherited_classes.get(name, name),
                            loader_type=f"Loader[{self.inherited_classes.get(name, name)}]",
                        )
                    )
                else:

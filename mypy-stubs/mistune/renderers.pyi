...
Method: TypeAlias = Callable[[str, Any, Any], Any]
...
class BaseRenderer(Generic[DataT]):
    ...
    def _get_method(self, name: AstType) -> Method: ...
...
class AstRenderer(BaseRenderer[AstChildren]):
    ...
    def _create_default_method(self, name: AstType) -> Method: ...
    def _get_method(self, name: AstType) -> Method: ...
    def text(self, text: str) -> AstChildren: ...
    def link(self, link: str, text: Optional[str] = None, title: Optional[str] = None) -> AstChildren: ...
    ...
    def list(self, children: str, ordered: bool, level: int, start: Optional[int] = None) -> AstChildren: ...
...
class HTMLRenderer(BaseRenderer[str]):
    ...
    def linebreak(self, text: str) -> str: ...
    def inline_html(self, text: str) -> str: ...
    def paragraph(self, text: str) -> str: ...
    def heading(self, text: str, level: int) -> str: ...
    def newline(self) -> str: ...
    def thematic_break(self) -> str: ...
    def block_break(self, text: str) -> str: ...
    def block_code(self, code: str, info: Optional[str] = None) -> str: ...
    def block_quote(self, text: str) -> str: ...
    def block_html(self, html: str) -> str: ...
    def block_error(self, html: str) -> str: ...
    def list(self, text: str, ordered: bool, level: int, start: Optional[int] = None) -> str: ...
    def list_item(self, text: str, level: int) -> str: ...
    def finalize(self, data: DataT) -> str: ...

...
public class LoadingOptions {
    ...
    public String expandUrl(String url_, final String baseUrl, final boolean scopedId, final boolean vocabTerm, final Integer scopedRef) {
        ...
        if(scheme != null && 
            ...
            try {
                url = new URI(splitbase.getScheme(), splitbase.getAuthority(), pt, splitbase.getQuery(), frg).toString();
            ...
            try {
                url = new URI(splitbase.getScheme(), splitbase.getAuthority(), splitbase.getPath(), splitbase.getQuery(), fragment).toString();
            } catch(java.net.URISyntaxException e) {
                throw new RuntimeException(e);
            }
        } else {

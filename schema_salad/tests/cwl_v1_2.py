...
class File(Saveable):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `File` but", None, _errors__)
        _constructed = cls(
            location=location,
            path=path,
            basename=basename,
...
class Directory(Saveable):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `Directory` but", None, _errors__)
        _constructed = cls(
            location=location,
            path=path,
            basename=basename,
...
class InputBinding(Saveable):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `InputBinding` but", None, _errors__)
        _constructed = cls(
...
class InputRecordField(RecordField, FieldBase, InputFormat, LoadContents):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `InputRecordField` but", None, _errors__)
        _constructed = cls(
            doc=doc,
            name=name,
            type_=type_,
...
class InputRecordSchema(RecordSchema, InputSchema):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `InputRecordSchema` but", None, _errors__)
        _constructed = cls(
            fields=fields,
            type_=type_,
            label=label,
...
class InputEnumSchema(EnumSchema, InputSchema):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `InputEnumSchema` but", None, _errors__)
        _constructed = cls(
            name=name,
            symbols=symbols,
            type_=type_,
...
class InputArraySchema(ArraySchema, InputSchema):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `InputArraySchema` but", None, _errors__)
        _constructed = cls(
            items=items,
            type_=type_,
            label=label,
...
class OutputRecordField(RecordField, FieldBase, OutputFormat):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `OutputRecordField` but", None, _errors__)
        _constructed = cls(
            doc=doc,
            name=name,
            type_=type_,
...
class OutputRecordSchema(RecordSchema, OutputSchema):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `OutputRecordSchema` but", None, _errors__)
        _constructed = cls(
            fields=fields,
            type_=type_,
            label=label,
...
class OutputEnumSchema(EnumSchema, OutputSchema):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `OutputEnumSchema` but", None, _errors__)
        _constructed = cls(
            name=name,
            symbols=symbols,
            type_=type_,
...
class OutputArraySchema(ArraySchema, OutputSchema):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `OutputArraySchema` but", None, _errors__)
        _constructed = cls(
            items=items,
            type_=type_,
            label=label,
...
class EnvironmentDef(Saveable):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `EnvironmentDef` but", None, _errors__)
        _constructed = cls(
            envName=envName,
            envValue=envValue,
            extension_fields=extension_fields,
...
class CommandLineBinding(InputBinding):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `CommandLineBinding` but", None, _errors__)
        _constructed = cls(
            loadContents=loadContents,
            position=position,
            prefix=prefix,
...
class CommandLineTool(Process):
    ...
    def fromDoc(
        ...
        if "intent" in _doc:
            try:
                if _doc.get("intent") is None:
                    raise ValidationException("* missing required field `intent`", None, [])
        ...
        if _errors__:
            raise ValidationException("tried `CommandLineTool` but", None, _errors__)
        _constructed = cls(
            id=id,
            label=label,
            doc=doc,
...
class DockerRequirement(ProcessRequirement):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `DockerRequirement` but", None, _errors__)
        _constructed = cls(
...
class SoftwarePackage(Saveable):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `SoftwarePackage` but", None, _errors__)
        _constructed = cls(
            package=package,
            version=version,
            specs=specs,
...
class Dirent(Saveable):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `Dirent` but", None, _errors__)
        _constructed = cls(
            entryname=entryname,
            entry=entry,
            writable=writable,
...
class EnvVarRequirement(ProcessRequirement):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `EnvVarRequirement` but", None, _errors__)
        _constructed = cls(
            envDef=envDef,
            extension_fields=extension_fields,
            loadingOptions=loadingOptions,
...
class WorkReuse(ProcessRequirement):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `WorkReuse` but", None, _errors__)
        _constructed = cls(
...
class NetworkAccess(ProcessRequirement):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `NetworkAccess` but", None, _errors__)
        _constructed = cls(
...
class ToolTimeLimit(ProcessRequirement):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `ToolTimeLimit` but", None, _errors__)
        _constructed = cls(
            timelimit=timelimit,
            extension_fields=extension_fields,
            loadingOptions=loadingOptions,
...
class ExpressionTool(Process):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `ExpressionTool` but", None, _errors__)
        _constructed = cls(
            id=id,
            label=label,
            doc=doc,
...
class WorkflowOutputParameter(OutputParameter):
    ...
    def fromDoc(
        ...
        if "pickValue" in _doc:
            try:
                if _doc.get("pickValue") is None:
                    raise ValidationException("* missing required field `pickValue`", None, [])
...
class WorkflowStepInput(Identified, Sink, LoadContents, Labeled):
    ...
    * **all_non_null**
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `WorkflowStepInput` but", None, _errors__)
        _constructed = cls(
            id=id,
            source=source,
            linkMerge=linkMerge,
...
class WorkflowStepOutput(Identified):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `WorkflowStepOutput` but", None, _errors__)
        _constructed = cls(
            id=id,
            extension_fields=extension_fields,
            loadingOptions=loadingOptions,
...
class WorkflowStep(Identified, Labeled, Documented):
    ...
    def fromDoc(
        ...
        if "when" in _doc:
            try:
                if _doc.get("when") is None:
                    raise ValidationException("* missing required field `when`", None, [])
        ...
        if _errors__:
            raise ValidationException("tried `WorkflowStep` but", None, _errors__)
        _constructed = cls(
            id=id,
            label=label,
            doc=doc,
...
class Workflow(Process):
    ...
    * If all workflow steps are executed and complete with `success`, then the
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException("tried `Workflow` but", None, _errors__)
        _constructed = cls(
            id=id,
            label=label,
            doc=doc,
...
class MultipleInputFeatureRequirement(ProcessRequirement):
    ...
    def fromDoc(
        ...
        if _errors__:
            raise ValidationException(
                "tried `MultipleInputFeatureRequirement` but", None, _errors__
            )
        _constructed = cls(
            extension_fields=extension_fields,
            loadingOptions=loadingOptions,
...
class Operation(Process):
    ...
    def fromDoc(
        ...
        if _doc.get("class") != "Operation":
            raise ValidationException("tried `Operation` but")
        ...
        if _errors__:
            raise ValidationException("tried `Operation` but", None, _errors__)
        _constructed = cls(
            id=id,
            label=label,
            doc=doc,

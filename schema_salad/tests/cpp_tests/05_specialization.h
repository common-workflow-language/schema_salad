...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordA::fromYaml(YAML::Node const& n) {
    using ::fromYaml;
}
...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordB::fromYaml(YAML::Node const& n) {
    using ::fromYaml;
}
...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordOne::fromYaml(YAML::Node const& n) {
    using ::fromYaml;
...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordTwo::fromYaml(YAML::Node const& n) {
    using ::fromYaml;
    fromYaml(n["name"], *name);

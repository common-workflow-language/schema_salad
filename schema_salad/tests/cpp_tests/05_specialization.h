...
namespace file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml { struct FieldRecordA; }
namespace file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml { struct FieldRecordB; }
namespace file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml { struct MyRecordOne; }
namespace file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml { struct MyRecordTwo; }
namespace file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml {
struct FieldRecordA {
...
inline auto file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordA::toYaml() const -> YAML::Node {
    using ::toYaml;
    auto n = YAML::Node{};
    return n;
}
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordA::fromYaml([[maybe_unused]] YAML::Node const& n) {
    using ::fromYaml;
}

template <>
struct DetectAndExtractFromYaml<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordA> {
    auto operator()(YAML::Node const& n) const -> std::optional<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordA> {
        if (!n.IsDefined()) return std::nullopt;
        if (!n.IsMap()) return std::nullopt;
        auto res = file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordA{};

        return std::nullopt;
    }
};
inline auto file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordB::toYaml() const -> YAML::Node {
    using ::toYaml;
    auto n = YAML::Node{};
    return n;
}
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordB::fromYaml([[maybe_unused]] YAML::Node const& n) {
    using ::fromYaml;
}

template <>
struct DetectAndExtractFromYaml<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordB> {
    auto operator()(YAML::Node const& n) const -> std::optional<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordB> {
        if (!n.IsDefined()) return std::nullopt;
        if (!n.IsMap()) return std::nullopt;
        auto res = file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::FieldRecordB{};

        return std::nullopt;
    }
};
inline auto file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordOne::toYaml() const -> YAML::Node {
    using ::toYaml;
    auto n = YAML::Node{};
    addYamlField(n, "name", toYaml(*name));
    return n;
}
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordOne::fromYaml([[maybe_unused]] YAML::Node const& n) {
    using ::fromYaml;
    fromYaml(n["name"], *name);
}

template <>
struct DetectAndExtractFromYaml<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordOne> {
    auto operator()(YAML::Node const& n) const -> std::optional<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordOne> {
        if (!n.IsDefined()) return std::nullopt;
        if (!n.IsMap()) return std::nullopt;
        auto res = file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordOne{};
...
inline auto file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordTwo::toYaml() const -> YAML::Node {
    using ::toYaml;
    auto n = YAML::Node{};
    addYamlField(n, "name", toYaml(*name));
...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordTwo::fromYaml([[maybe_unused]] YAML::Node const& n) {
    using ::fromYaml;
    fromYaml(n["name"], *name);
...
template <>
struct DetectAndExtractFromYaml<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordTwo> {
    auto operator()(YAML::Node const& n) const -> std::optional<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordTwo> {
        if (!n.IsDefined()) return std::nullopt;
        if (!n.IsMap()) return std::nullopt;
        auto res = file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_05_specialization_yml::MyRecordTwo{};

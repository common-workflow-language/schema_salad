...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordOne::fromYaml([[maybe_unused]] YAML::Node const& n) {
    using ::fromYaml;
    fromYaml(n["name"], *name);
}

template <>
struct DetectAndExtractFromYaml<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordOne> {
    auto operator()(YAML::Node const& n) const -> std::optional<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordOne> {
        if (!n.IsDefined()) return std::nullopt;
        if (!n.IsMap()) return std::nullopt;
        auto res = file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordOne{};
...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordTwo::fromYaml([[maybe_unused]] YAML::Node const& n) {
    using ::fromYaml;
    file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordOne::fromYaml(n);
    fromYaml(n["value"], *value);
}

template <>
struct DetectAndExtractFromYaml<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordTwo> {
    auto operator()(YAML::Node const& n) const -> std::optional<file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordTwo> {
        if (!n.IsDefined()) return std::nullopt;
        if (!n.IsMap()) return std::nullopt;
        auto res = file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordTwo{};

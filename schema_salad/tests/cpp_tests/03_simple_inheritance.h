...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordOne::fromYaml(YAML::Node const& n) {
    using ::fromYaml;
...
inline void file____home_gene_Coding_schema_salad_schema_salad_tests_cpp_tests_03_simple_inheritance_yml::MyRecordTwo::fromYaml(YAML::Node const& n) {
    using ::fromYaml;
